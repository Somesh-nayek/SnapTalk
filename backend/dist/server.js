    ...
    ws.on("message", function message(data) {
        ...
        try {
            if (message.type === "newRoom") {
                ...
                if (rooms.has(code)) {
                    (_a = rooms.get(code)) === null || _a === void 0 ? void 0 : _a.push(ws);
                    ws.send(JSON.stringify({ type: "joinedRoom", payload: { code: code } }) //
                    );
                }
                else {
                ...
                const code = message.payload.roomCode;
                if (rooms.has(code)) {
                    (_b = rooms.get(code)) === null || _b === void 0 ? void 0 : _b.forEach((client) => {
                        if (client !== ws) {
